...
_ACCEPT_TESTS = [
    ...
    # Accept-Charset
    ("iso-8859-5, unicode-1-1;q=0.8", [("iso-8859-5", 1.0), ("unicode-1-1", 0.8)]),
    # Accept-Encoding
    ("*", [("*", 1.0)]),
...
_CONTENT_TESTS = [
    ...
    ("text/html; charset=ISO-8859-4", ("text/html", [("charset", "ISO-8859-4")])),
]
...
VALID_RETRY_AFTERS = ["Fri, 31 Dec 1999 23:59:59 GMT", "120"]
